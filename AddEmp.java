...
public class AddEmp extends javax.swing.JDialog {
    ...
    try {
        ...
        // حفظ في EMPLOYEES
        String sql = "INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, JOB_ID, DEPARTMENT_ID, SALARY, HIRE_DATE) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        ps.setDate(7, java.sql.Date.valueOf(jTextField7.getText()));
        ps.executeUpdate();
        
        javax.swing.JOptionPane.showMessageDialog(this, "Add successfully");
        dispose();
