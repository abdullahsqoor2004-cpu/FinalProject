...
public class Payroll_Details extends javax.swing.JDialog {
    ...
    public Payroll_Details(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addNumberOnly(jTextField4);  // Overtime
        addNumberOnly(jTextField5);  // Bonuses
        addNumberOnly(jTextField8);  // Allowances
        addNumberOnly(jTextField9);  // Deduction
        addNumberOnly(jTextField10); // Warranty
    }
    ...
    public void setPayrollData(String empId, String firstName, String lastName,
        ...
        jTextField1.setText(empId);                       // EMP_ID
        jTextField6.setText(firstName + " " + lastName);  // EMP_NAME
        jTextField2.setText(job);                          // JOB_ID
        jTextField7.setText(dept);                         // DEPARTMENT
        jTextField3.setText(basicSalary);                  // BASIC_SALARY
